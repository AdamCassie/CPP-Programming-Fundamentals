...
private:
   ...
   void delete_tree(TreeNode* myroot);
   bool insert_entry(TreeNode*& p, TreeNode* r);
   DBentry* find_name(string n, TreeNode* r);
   void getNumActive(int* p, TreeNode* r) const;
   void printTree(ostream& out, TreeNode* r) const;
   TreeNode* remove_entry (TreeNode* r, string n);
